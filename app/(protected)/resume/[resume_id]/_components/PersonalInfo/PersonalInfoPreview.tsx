...
const PersonalInfoPreview = ({ personalInfoData }: { personalInfoData: any }) => {
  if (!personalInfoData) return null;
    ...
    <section className="text-gray-800 space-y-4 print:break-inside-avoid ">
      ...
      <div>
        ...
        <p className="text-gray-800 leading-relaxed text-sm capitalize">
          {summary || "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quibusdam."}
        </p>
      </div>
    </section>
  );
